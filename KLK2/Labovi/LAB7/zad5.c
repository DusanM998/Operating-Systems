/*Linux program koji se deli u 2 procesa. Proces roditelj cita sa tastature stringove i prosledjuje ih procesu detetu. Proces dete primljene stringove upisuje u datoteku "stringovi.txt". Kada korisnik unese string "KRAJ" komunikacija se prekida i procesi se zavrsavaju.*/
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
#include <sys/types.h>
...
int main()
{
    ...
    if(fork() != 0)
    {
        ...
        {
            semop(procaid, &sem_lock, 1); //Pristupa deljenoj memoriji
