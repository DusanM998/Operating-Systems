/*Linux program koji u zadatom direktorijumu rekurzivno(maximalno do dubine 3) brise sve regularne datoteke cija je velicina veca od 10KB. Za brisanje datoteka koristi "rm" komandu Linuxa*/
...
int main(int argc, char* argv[])
{
    ...
    if(stat(dirname, &statbuf) < 0) //F-ja stat ucitava status o unetoj putanji
    {
